...
| 策略 | 输出路径 | 说明 |
|------|---------|------|
| direct | `specs/drafts/design-v{N}.md` | 直接产出设计 |
| review | `specs/drafts/design-v{N}.md` → `specs/design.md` | 草稿 → 审批后定义|
| change | `specs/design.md` 修改 → `specs/changes/{YYYYMMDD}-{desc}.md` | 变更既有设计 |
